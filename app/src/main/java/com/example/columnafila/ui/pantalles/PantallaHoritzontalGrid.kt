...
@Composable
fun PantallaLazyHorizontalGrid(pilots: List<Pilot> = dadesPilots.getPilots()) {
    LazyHorizontalGrid(
        rows = GridCells.Fixed(2), // Número de filas en la cuadrícula horizontal
        modifier = Modifier
            .padding(16.dp)
            .fillMaxSize()
            ...
            ListItem(
                ...
                headlineContent = {
                    Text(
                        ...
                        fontSize = 14.sp // Tamaño de letra personalizado
                    )
                },
                supportingContent = {
                    Text(
